...
<div class="container-fluid">
    ...
    <div class="row">
	    ...
	    <div class="col-md-6">
            ...
            <a href="<?php echo e(url('roles/create')); ?>" class="btn btn-primary btn-sm" style="float:right;"><i class="fas fa-user-plus"></i> Add Role</a>
	    </div>
    </div>
    <!-- END ROW 1 -->
    <br />
                        ...
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button> <a href="<?php echo e(url('roles/edit/'.$role->id)); ?>"> Edit</a></button>
                                    <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\orify\jwt-api\resources\views\admin\roles\index.blade.php ENDPATH**/ ?>